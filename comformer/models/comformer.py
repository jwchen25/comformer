...
class iComformerConfig(BaseSettings):
    """Hyperparameter schema for iComformer model (Pydantic v2)."""
    ...
    model_config = ConfigDict(env_prefix="jv_model")


class eComformerConfig(BaseSettings):
    """Hyperparameter schema for eComformer model (Pydantic v2)."""
